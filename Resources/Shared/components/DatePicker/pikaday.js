...
if ($('body').hasClass('rtl')) {
    moment.loadPersian();
    /*!
        Fix Jalaali Date Dnnplus.ir  2018
        Soheil kheiri & Mansour Nazifi
    */
        ...
        return function (Date, oDate) {
            ...
            Pikaday.prototype = {
                ...
                setDate: function (date, preventOnSelect) {
                    ...
                    // fix input shamsi date
                    if (this._o.field) {
                        this._o.field.value = moment(this.toString()).format('jYYYY/jMM/jDD HH:mm:ss');
                ...
                gotoDate: function (date) {
                    ...
                    if (newCalendar) {
                        ...
                        if (date.getFullYear() < 1000) {
                            //fix renew shamsi calendars
                            this.calendars = [{
                                month: moment(date).format('jM'),
