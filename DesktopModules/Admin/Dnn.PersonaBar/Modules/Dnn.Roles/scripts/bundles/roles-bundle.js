! function (e) {
    ...
    */
    ...
    var p = function (e) {
        ...
        return c(t, e), t.prototype.render = function () {
            ...
            return A.default.createElement(i, s({}, a, {
                in: o, dropUp: n, className: (0, r.default)(t, "rw-popup-container")
    ...
    var f = ((r = {})[c.ENTERING] = "rw-popup-transition-entering", r[c.EXITING] = "rw-popup-transition-exiting", r[c.EXITED] = "rw-popup-transition-exited", r),
        h = {
            in: s.default.bool.isRequired, dropUp: s.default.bool, onEntering: s.default.func, onEntered: s.default.func
        };
    var g = function (e) {
        var t, n;
    ...
    d.contextTypes = {
        ...
        in: !1, mountOnEnter: !1, unmountOnExit: !1, appear: !1, enter: !0, exit: !0, onEnter: p, onEntering: p, onEntered: p, onExit: p, onExiting: p, onExited: p
