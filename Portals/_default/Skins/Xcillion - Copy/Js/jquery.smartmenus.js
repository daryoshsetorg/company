    ...
    ! function (t) {
                    ...
                    ["mousemove", function (i) {
                        ...
                        if (l) {
                            var s = Math.abs(l.x - e.x),
                                o = Math.abs(l.y - e.y);
                            if ((s > 0 || o > 0) && 2 >= s && 2 >= o && e.timeStamp - l.timeStamp <= 300 && (n = !0, u)) {
        ...
        t.SmartMenus = function (i, e) {
            ...
            prototype: {
                ...
                docClick: function (i) {
                    return this.isTouchScrolling ? void (this.isTouchScrolling = !1) : void ((this.visibleSubMenus.length && !t.contains(this.$root[0], i.target) || t(i.target).is("a")) && this.menuHideAll())
                },
                    ...
                    if (T ? (e = I ? f - l - $ : $, a = this.opts.bottomToTopSubMenus ? -c - x : v + x) : (e = I ? $ - l : f - $, a = this.opts.bottomToTopSubMenus ? v - x - c : x), this.opts.keepInViewport) {
                        ...
                        if (I && S > y ? e = T ? S - y + e : f - $ : !I && y + l > S + M && (e = T ? S + M - l - y + e : $ - l), T || (w > c && C + c > g + w ? a += g + w - c - C : (c >= w || g > C) && (a += g - C)), T && (C + c > g + w + .49 || g > C) || !T && c > w + .49) {
                            ...
                            i.dataSM("scroll", {
                                ...
                                top: "auto",
                                right: "0",
                                marginRight: e + (parseInt(i.css("border-left-width")) || 0),
                ...
                menuScroll: function (t, i, e) {
                    ...
                    if (!i && o.velocity) {
                        if (o.velocity *= .9, s = o.velocity, .5 > s) return void this.menuScrollStop(t)
                    ...
                    if (t.add(t.dataSM("ie-shim")).css("margin-top", l), n && (o.up && l > o.downEnd || !o.up && l < o.upEnd) && a.eq(o.up ? 1 : 0).show(), l == h) n && a.eq(o.up ? 0 : 1).hide(), this.menuScrollStop(t);
                    else if (!i) {
                ...
                menuScrollTouch: function (i, s) {
                    if (s = s.originalEvent, e(s)) {
                        ...
                        if (this.getClosestMenu(o.target) == i[0]) {
                            ...
                            } else void 0 !== a.touchY && (s.timeStamp - a.touchTimestamp < 120 && a.velocity > 0 && (a.velocity *= .5, this.menuScrollStop(i), this.menuScroll(i), s.preventDefault()), delete a.touchY)
                        }
                    }
                },
                menuShow: function (t) {
